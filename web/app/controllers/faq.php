		...
		<div class="card my-1">
			...
			<div id="collapseOne" class="collapse">
				<div class="card-body">
					...
					<p>这个时候<?= UOJConfig::$data['profile']['oj-name-short'] ?>出现了，于是<?= UOJConfig::$data['profile']['oj-name-short'] ?>就使用了这套系统。Universal的中文意思是通用，之所以称之为UOJ，因为我们所有题目从编译、运行到评分，都可以由出题人自定义。</p>
